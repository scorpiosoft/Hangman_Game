...
var Hangman =
{
  ...
  d_wins:      $("#hang_wins"),
  d_message:   $("#hang_message"),
  d_word:      $("#hang_word"),
  d_guesses:   $("#hang_guesses"),
  d_gallows:   $("#hang_gallows"),
  // DOM elements for playing sounds, JavaScript handles; jQuery does not have it's own audio functions
  ...
  start_game: function()
  {
    ...
    this.d_word.text(this.cur_display);
    this.cur_correct = 0;
    this.cur_misses = 0;
    this.set_gallows();
    ...
    this.a_hits = [];
    this.a_misses = [];
    this.d_guesses.empty();
  },
  // method to end the current game
  end_game: function(msg)
  {
    this.started = false;
    this.d_word.text(msg);
    this.d_message.text("Press any key to start.");
  },
  // method to set the gallows image
  set_gallows: function()
  {
    this.cur_gallows = "assets/images/hangman" + this.cur_misses.toString() + ".png";
  },
...
document.onkeyup = function(event)
{
  ...
  var e_key_upper = e_key.toUpperCase();
